...
import com.spring.springboot.transactiondeclarative.service.FooService;
...
@Slf4j
public class SpringbootDataTransactionDeclarativeApplication implements CommandLineRunner {
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringbootDataTransactionDeclarativeApplication.class, args);
    }
