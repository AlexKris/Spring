package com.spring.springboot.mybatis;

import com.spring.springboot.mybatis.entity.Coffee;
import com.spring.springboot.mybatis.mapper.CoffeeMapper;
...
public class SpringbootOrmMybatisApplication implements ApplicationRunner {
    @Autowired
