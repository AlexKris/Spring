package com.spring.springboot.mybatis.page.helper;

import com.github.pagehelper.PageInfo;
import com.spring.springboot.mybatis.page.helper.entity.Coffee;
import com.spring.springboot.mybatis.page.helper.mapper.CoffeeMapper;
...
public class SpringbootOrmMybatisPageHelperApplication implements ApplicationRunner {
    @Autowired
    private CoffeeMapper coffeeMapper;

    public static void main(String[] args) {
        SpringApplication.run(SpringbootOrmMybatisPageHelperApplication.class, args);
    }
