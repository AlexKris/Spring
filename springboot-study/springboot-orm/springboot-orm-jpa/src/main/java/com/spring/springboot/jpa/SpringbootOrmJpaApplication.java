...
import com.spring.springboot.jpa.entity.Coffee;
import com.spring.springboot.jpa.entity.CoffeeOrder;
import com.spring.springboot.jpa.repository.CoffeeOrderRepository;
import com.spring.springboot.jpa.repository.CoffeeRepository;
...
@Slf4j
public class SpringbootOrmJpaApplication implements CommandLineRunner {
    @Autowired
