package com.spring.springboot.jpaext;

import com.spring.springboot.jpaext.entity.Coffee;
import com.spring.springboot.jpaext.entity.CoffeeOrder;
import com.spring.springboot.jpaext.entity.OrderState;
import com.spring.springboot.jpaext.repository.CoffeeOrderRepository;
import com.spring.springboot.jpaext.repository.CoffeeRepository;
...
@Slf4j
public class SpringbootOrmJpaExtApplication implements CommandLineRunner {
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringbootOrmJpaExtApplication.class, args);
    }
