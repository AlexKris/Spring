...
import com.spring.generator.mapper.CoffeeMapper;
...
public class SpringOrmappingMybatisGeneratorApplication implements ApplicationRunner {
    @Autowired
    private CoffeeMapper coffeeMapper;

    public static void main(String[] args) {
        SpringApplication.run(SpringOrmappingMybatisGeneratorApplication.class, args);
    }
