...
import com.spring.mongodb.converter.MoneyReadConverter;
import com.spring.mongodb.entity.Coffee;
import com.spring.mongodb.repository.CoffeeRepository;
...
public class SpringNosqlMongodbApplication implements ApplicationRunner {
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringNosqlMongodbApplication.class, args);
    }
